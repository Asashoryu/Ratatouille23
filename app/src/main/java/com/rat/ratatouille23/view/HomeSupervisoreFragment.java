...
public class HomeSupervisoreFragment extends Fragment {
    ...
    public void onResume() {
        ...
        bundle.putString(FirebaseAnalytics.Param.SCREEN_NAME, "Schermata Home Supervisore");
        bundle.putString(FirebaseAnalytics.Param.SCREEN_CLASS, "HomeSupervisoreFragment");
